...
const DESCRIPTION =
  "Татьяна Бойраз — клинический психолог, нейропсихолог. Помогаю детям учиться: нахожу причины трудностей в обучении и пути их решения.";
...
const VALUES = [
  ...
  },
  {
    num: "03",
    title: "Честность",
    description: "Прозрачные договорные отношения и коррекционный процесс.",
  },
  {
    num: "04",
    title: "Эффективность",
    description: "Предпочитаю работающие методы и методики.",
  },
];

const STEPS = [
  { num: "01", title: "Знакомство", description: "Определяем запрос." },
  { num: "02", title: "Диагностика", description: "Оцениваем актуальное состояние." },
  {
    num: "03",
    title: "Индивидуальный коррекционный маршрут",
    description: "Составляем индивидуальную программу занятий.",
  },
  {
    num: "04",
    title: "Коррекционные занятия и сопровождение",
    description: "Проведение занятий и сопровождение на протяжении всего курса.",
  },
];
...
const AUDIENCES = [
  {
    title: "Дети",
    description:
      "Я работаю с детьми школьного возраста с 1 по 9 класс, имеющими трудности обучения по основным предметам, ЗПР, СДВГ в анамнезе, дискалькулию, дисграфию, дислексию.\n\nСпециалист по работе с дискалькулией.\n\nТакже работаю с тревожностью, страхами.",
  },
  {
    title: "Взрослые",
    description:
      "Работа с тревожностью, фобиями и страхами, ОКР, отношениями, семьями, самооценкой, уверенностью в себе.",
  },
];
      ...
      <main>
          ...
          <div className="container-page relative grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <Reveal>
              ...
              <p className="mt-7 max-w-md text-base leading-[1.75] text-muted-foreground sm:text-[17px]">
                Нейропсихология помогает найти причины трудностей в обучении и пути их решения.
              </p>
            </Reveal>
          ...
          <div className="container-page grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
            ...
            <Reveal delay={120}>
              <div className="max-w-[620px] space-y-5 text-[15px] leading-[1.8] text-muted-foreground sm:text-base">
                <p>
                  Я клинический психолог, специальный психолог, нейропсихолог, психолог, педагог по
                  скорочтению.
                </p>
                <p>В нейропсихологии моя отдельная любовь — это дискалькулия.</p>
                <p>Я работаю с детьми школьного возраста с 1 по 9 класс.</p>
                <p>
                  Также я консультирую в краткосрочном подходе по вопросам детско-родительских
                  отношений, тревожности, фобий и страхов, ОКР, самооценки.
                </p>
                <p>
                  Кроме того, я разработчик. Это мое хобби. Я разрабатываю коррекционно-развивающие
                  игры для онлайн-занятий для коллег (нейропсихологов, логопедов, дефектологов) и
                  приложения.
                </p>
                <p>
                  Также я люблю изучать иностранные языки, играть в настольные игры, заниматься
                  рукоделием, вокалом, танцами.
                </p>
              </div>
            </Reveal>
          </div>
            ...
            <Reveal>
              <blockquote className="mx-auto max-w-3xl border-l border-gold/60 pl-7 md:pl-10">
                <p className="font-heading text-[26px] leading-[1.3] text-gold-light italic sm:text-[32px] lg:text-[36px]">
                  Я очень люблю нейропсихологию за то, что она точно может ответить на вопрос
                  «Почему» мозг работает не так, как нам хотелось бы и «Что делать?» с этим.
                </p>
              </blockquote>
            </Reveal>
          </div>
        ...
        >
          <div className="container-page">
            <Reveal>
              <SectionTitle
                id="mission-title"
                subtitle="Помогать детям учиться легче"
              >
                Моя миссия
              </SectionTitle>
            </Reveal>
            <div className="mt-14 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <Reveal delay={120}>
                <div className="max-w-[620px] space-y-5 text-[15px] leading-[1.8] text-muted-foreground sm:text-base">
                  <p>
                    В школе ребенок проводит 10 лет своей жизни. Кому-то учеба дается легко, а
                    кому-то очень тяжело. Но это не приговор.
                  </p>
                  <p>
                    Трудности можно преодолеть и сделать процесс обучения приятным и интересным.
                  </p>
                  <p>
                    Каждый ребенок может усваивать школьную программу и учиться с удовольствием.
                  </p>
                </div>
              </Reveal>
            </div>
                ...
                <Reveal as="li" key={s.num} delay={i * 100}>
                  <div className="relative flex gap-5 lg:block lg:px-8">
                    ...
                    <div className="lg:mt-6">
                      <h3 className="font-body text-[13px] font-semibold leading-snug tracking-[0.14em] text-foreground uppercase break-words">
                        {s.title}
                      </h3>
        ...
        >
          <div className="container-page">
            ...
            <ul className="mt-14 grid gap-6 md:grid-cols-2 lg:max-w-[920px] lg:mx-auto lg:gap-8">
              {AUDIENCES.map((a, i) => (
                <Reveal as="li" key={a.title} delay={i * 90}>
                  <article className="group flex min-h-[200px] flex-col rounded-[18px] border border-gold/35 bg-card p-8 transition-all duration-[250ms] ease-out hover:-translate-y-[3px] hover:border-gold hover:bg-card-hover">
                    ...
                    />
                    <p className="mt-4 whitespace-pre-line text-[14px] leading-[1.7] text-muted-foreground">
                      {a.description}
                    </p>
                  </article>
                </Reveal>
